...
import com.josueyax.webapp.biblioteca.service.LibroService;
...
public class LibroControllerFX implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        cmbCategoria.setItems(FXCollections.observableList(categoriaService.listarCategoria()));
        cargarDatos();
    }
    ...
    public void handleButtonAction(ActionEvent event) {
        if (event.getSource() == btnGuardar) {
            ...
            if (tfBuscar.getText().isBlank()) {
                ...
                tblLibros.getItems().add(buscarLibroPorId());
